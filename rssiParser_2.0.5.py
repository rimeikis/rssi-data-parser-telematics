## CHANGELOG ##
# Pridejau multiple scenarijus vienam testui
# Pridejau data saugojima i exceli ir atskirus sheets pagal scenariju

## Todo list ##
# sutvarkyk laika, nes bloga duration ikelia i exceli. padaryk testa x laiko trukmes ir ziurek kiek duration atvaizduoja excely.
# ridet available MAC adresu sarasa po scan'o. Islistint unikalius IMEI ir ju MAC salia vienas kito. Su 1,2,3... inputais pasirinkt kurio rssi nori detektint
# sutvarkyt kad netycia ivedus netinkama comporta: rasytu loading... press X to return arba po kazkiek timeoutintu ir rasytu kad nesulauke jokiu rssi duomenu
